...
<STRONG>Bionic muscle-driven variable-stiffness design</STRONG><BR>
...
<ol class="articles-list">
  <li><strong>Yan Zhang</strong>,Xue Dinghao,Zhao Bin,Shi Mai,Nan Xiaolu,Zhao Yingheng,Ge Qinggang,Zhang Yuru, Wang Zongyu,Feng Yanggang and Wang Dangxiao. A Systematic Review of Soft Respiratory Exoskeletons: Assistance Mechanisms, System Architectures, and Key Technologies in <em>IEEE Transactions on Neural Systems and Rehabilitation Engineering</em>, 2026.(First Author)</li>
